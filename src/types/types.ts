export interface ServerData {
  ...
  assigned_to: { person_name: string; status: string }[];
  status: string;
  priority: string;
}
    ...
    data: [
      {
        ...
        assigned_to: [{ person_name: "Technician One", status: "Assigned" }],
        status: "New",
        priority: "Low",
      },
      {
        ...
        assigned_to: [{ person_name: "Technician Two", status: "Assigned" }],
        status: "New",
        priority: "Low",
      },
      {
        ...
        assigned_to: [{ person_name: "Technician One", status: "In progress" }],
        status: "Confirmed",
        priority: "High",
      },
      {
        ...
        assigned_to: [
          { person_name: "Technician Two", status: "Assigned" },
          { person_name: "Technician One", status: "In progress" },
        ],
        status: "Confirmed",
        priority: "High",
      },
      {
        ...
        assigned_to: [{ person_name: "Technician Two", status: "Confirmed" }],
        status: "Confirmed",
        priority: "Normal",
      },
      {
      ...
      },
      {
        ...
        assigned_to: [{ person_name: "Technician Two", status: "Completed" }],
        status: "Completed",
        priority: "Low",
      },
    ],
